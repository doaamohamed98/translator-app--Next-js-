...
export const RegisterSchema = yup.object().shape({
    fullName:yup.string().trim().required('Full Name is required').min(3,'Username must be at least 3 characters long').matches(fullNameRegex, 'Fullname must include at least first and last name'),
